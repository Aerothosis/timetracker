	...
	public void InsertUser()
	{
		try
		{
			...
			else
			{
				...
				String values = "'" + userIdIn + "','" + userIn.getText() + "','" + passIn.getText() + "','" + userNameIn.getText() + 
						"','" + userUICIn.getText() + "','" + userLvlIn.getText() + "','" + converted + "'";
				PreparedStatement stmt = conn.prepareStatement("insert into user_login (user_id,username,pass,name_first,name_last,account_status,regnum) values (" + values + ")");
				stmt.execute();
